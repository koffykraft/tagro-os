...
const SHELL=[...new Set(['/login.html','/work.html','/manage.html','/robots.txt','/os-shell.css','/service.css','/my-space.css','/intake.css','/work-space.css','/os-core.js','/app-shell.js','/service-core.js','/my-space.js','/intake.js','/work-space.js','/os-manifest.js','/os-icons.js','/tagro-logo.png',...APP_FILES])];
