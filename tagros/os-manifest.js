const TAGRO_MANIFEST = {
  ...
  apps: [
    ...
    { id:'jobs', label:'Repair Jobs', navIcon:'☷', navigation:['desktop','drawer'], icon:'jobs', description:'Receive, inspect, repair and deliver machines', file:'app-jobs.html', enabled:true, ready:true, access:{roles:['all']} },
