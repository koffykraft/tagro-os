const TAGRO_MANIFEST = {
  ...
  apps: [
    ...
    { id:'receive', label:'Receive', navIcon:'＋', navigation:['desktop','mobile-core','mobile-receive','drawer'], description:'Receive a machine for service', file:'receive.html', enabled:true, ready:true, launcher:false, access:{roles:['all']} },
    ...
    { id:'catalog', label:'Items & Parts', navIcon:'◇', navigation:['desktop','drawer'], icon:'catalog', description:'Machines, accessories, parts and service items', file:'app-catalog.html', enabled:true, ready:true, access:{roles:['all']} },
