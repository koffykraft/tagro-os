const TAGRO_MANIFEST = {
  ...
  apps: [
    ...
    { id:'billing', label:'Invoice Forms', navIcon:'₹', navigation:['desktop','drawer','mobile-core'], icon:'services', description:'Open the separate branch invoice training forms and export Busy-style Excel rows', file:'forms/index.html', enabled:true, ready:true, access:{roles:['all']} },
    ...
    { id:'transactions', label:'Transactions', navIcon:'⇄', navigation:['desktop','drawer'], icon:'reports', description:'Sales, purchases and estimates in one spreadsheet-style view', file:'app-transactions.html', enabled:true, ready:true, access:{roles:['all']} },
